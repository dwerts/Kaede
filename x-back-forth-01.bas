file = "c:\pecos\status\35-x-bf-01.txt"
num_repeats = 1
backoff_dist = 0
c_backoff_dist = 0
...
for i = 1 to 30
    display_status("1st plus sample " + str(i))
    inc_move("x", 0.0001)
    gosub log_sub
next i
...
for i = 1 to 30
    display_status("1st minus sample " + str(i))
    inc_move("x", -0.0001)
    gosub log_sub
next i

for i = 1 to 30
    display_status("2nd plus sample " + str(i))
    inc_move("x", 0.0001)
    gosub log_sub
next i
...
display_status("testing x minus")
for i = 1 to 30
    display_status("2nd minus sample " + str(i))
    inc_move("x", -0.0001)
    gosub log_sub
next i
for i = 1 to 30
    display_status("3rd plus sample " + str(i))
    inc_move("x", 0.0001)
    gosub log_sub
next i
...
display_status("testing x minus")
for i = 1 to 30
    display_status("3rd minus sample " + str(i))
    inc_move("x", -0.0001)
    gosub log_sub
next i
for i = 1 to 30
    display_status("4th plus sample " + str(i))
    inc_move("x", 0.0001)
    gosub log_sub
next i
...
display_status("testing x minus")
for i = 1 to 30
    display_status("4th minus sample " + str(i))
    inc_move("x", -0.0001)
    gosub log_sub
next i
