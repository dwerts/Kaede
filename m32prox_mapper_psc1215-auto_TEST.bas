...
dim point[4]
manual=0
xmax=22 - ref[0]	rem limit value - 1mm
ymax=20 - ref[1]	rem near the probe changer (about .25" clearance at largest dia on probe)
zmax=135 - ref[2]	rem up around the top pocket on probe changer
xmin=-244 - ref[0]	rem limit value + 1mm
ymin=-275 - ref[1]	rem limit value + 1mm
zmin=-324 - ref[2]	rem limit value + 1mm
xdiv=20
ydiv=8
zdiv=10
